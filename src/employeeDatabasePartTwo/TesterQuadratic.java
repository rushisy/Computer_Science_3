...
public class TesterQuadratic {
	...
	public static void main(String[] args) throws IOException {
		...
		EmployeeDatabaseQuadratic database = new EmployeeDatabaseQuadratic(50000);
		...
		String output = "";
		BufferedWriter writer = new BufferedWriter(new FileWriter("Quadratic Report.txt"));

		output += "Type of Hashing: Quadratic Probing\n";
